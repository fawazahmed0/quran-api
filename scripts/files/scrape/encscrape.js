...
for (name of arr){
  ...
  await page.goto(url+name+'/'+i,{timoeout:160000}).catch(async error =>
{
console.error(error)
await page.goto(url+name+'/'+i,{timoeout:160000})

})
textarr = await page.evaluate(() => {
  names = Array.from(document.querySelectorAll(".ttc"))
