...
export interface Page {
   ...
   */
  addInitScript(script: Function|string|PageAddInitScriptScript, arg?: Serializable): Promise<void>;
   ...
   * @param options 
   */
  dispatchEvent(selector: string, type: string, eventInit?: Object, options?: PageDispatchEventOptions): Promise<void>;
   ...
   */
  exposeBinding(name: string, playwrightBinding: Function): Promise<void>;
   ...
   * @param options 
   */
  getAttribute(selector: string, name: string, options?: PageGetAttributeOptions): Promise<null|string>;
   ...
   * @returns .
   */
  route(url: string|RegExp|((arg0 : URL) => boolean), handler: ((arg0 : Route, arg1 : Request) => void)): Promise<void>;
   ...
   */
  selectOption(selector: string, values: null|string|ElementHandle|Array<string>|PageSelectOptionValues|Array<ElementHandle>|Array<Object>, options?: PageSelectOptionOptions): Promise<Array<string>>;
   ...
   * @param options 
   */
  setInputFiles(selector: string, files: string|Array<string>|PageSetInputFilesFiles|Array<Object>, options?: PageSetInputFilesOptions): Promise<void>;
   ...
   * @param options 
   */
  textContent(selector: string, options?: PageTextContentOptions): Promise<null|string>;
   ...
   * @param handler Handler function to route the request.
   */
  unroute(url: string|RegExp|((arg0 : URL) => boolean), handler?: ((arg0 : Route, arg1 : Request) => void)): Promise<void>;
   ...
   * Emitted when the page closes.
   */
  waitForEvent(event: 'close', optionsOrPredicate?: { predicate?: () => boolean, timeout?: number }): Promise<void>;
   ...
   * ```
   */
  waitForEvent(event: 'console', optionsOrPredicate?: { predicate?: (consoleMessage : ConsoleMessage) => boolean, timeout?: number }): Promise<ConsoleMessage>;
   ...
   * ```
   */
  waitForEvent(event: 'crash', optionsOrPredicate?: { predicate?: () => boolean, timeout?: number }): Promise<void>;

  /**
   * Emitted when a JavaScript dialog appears, such as `alert`, `prompt`, `confirm` or `beforeunload`. Playwright can respond to the dialog via Dialog's accept or dismiss methods.
   */
  waitForEvent(event: 'dialog', optionsOrPredicate?: { predicate?: (dialog : Dialog) => boolean, timeout?: number }): Promise<Dialog>;

  /**
   * Emitted when the JavaScript `DOMContentLoaded` event is dispatched.
   */
  waitForEvent(event: 'domcontentloaded', optionsOrPredicate?: { predicate?: () => boolean, timeout?: number }): Promise<void>;
   ...
   * **NOTE** Browser context **must** be created with the `acceptDownloads` set to `true` when user needs access to the downloaded content. If `acceptDownloads` is not set or set to `false`, download events are emitted, but the actual download is not performed and user has no access to the downloaded files.
   */
  waitForEvent(event: 'download', optionsOrPredicate?: { predicate?: (download : Download) => boolean, timeout?: number }): Promise<Download>;
   ...
   * ```
   */
  waitForEvent(event: 'filechooser', optionsOrPredicate?: { predicate?: (fileChooser : FileChooser) => boolean, timeout?: number }): Promise<FileChooser>;

  /**
   * Emitted when a frame is attached.
   */
  waitForEvent(event: 'frameattached', optionsOrPredicate?: { predicate?: (frame : Frame) => boolean, timeout?: number }): Promise<Frame>;

  /**
   * Emitted when a frame is detached.
   */
  waitForEvent(event: 'framedetached', optionsOrPredicate?: { predicate?: (frame : Frame) => boolean, timeout?: number }): Promise<Frame>;

  /**
   * Emitted when a frame is navigated to a new url.
   */
  waitForEvent(event: 'framenavigated', optionsOrPredicate?: { predicate?: (frame : Frame) => boolean, timeout?: number }): Promise<Frame>;

  /**
   * Emitted when the JavaScript `load` event is dispatched.
   */
  waitForEvent(event: 'load', optionsOrPredicate?: { predicate?: () => boolean, timeout?: number }): Promise<void>;

  /**
   * Emitted when an uncaught exception happens within the page.
   */
  waitForEvent(event: 'pageerror', optionsOrPredicate?: { predicate?: (error : Error) => boolean, timeout?: number }): Promise<Error>;
   ...
   * **NOTE** Use `page.waitForLoadState([state[, options]])` to wait until the page gets to a particular state (you should not need it in most cases).
   */
  waitForEvent(event: 'popup', optionsOrPredicate?: { predicate?: (page : Page) => boolean, timeout?: number }): Promise<Page>;

  /**
   * Emitted when a page issues a request. The request object is read-only.
   * In order to intercept and mutate requests, see `page.route()` or `browserContext.route()`.
   */
  waitForEvent(event: 'request', optionsOrPredicate?: { predicate?: (request : Request) => boolean, timeout?: number }): Promise<Request>;
   ...
   * **NOTE** HTTP Error responses, such as 404 or 503, are still successful responses from HTTP standpoint, so request will complete with `'requestfinished'` event and not with `'requestfailed'`.
   */
  waitForEvent(event: 'requestfailed', optionsOrPredicate?: { predicate?: (request : Request) => boolean, timeout?: number }): Promise<Request>;

  /**
   * Emitted when a request finishes successfully.
   */
  waitForEvent(event: 'requestfinished', optionsOrPredicate?: { predicate?: (request : Request) => boolean, timeout?: number }): Promise<Request>;

  /**
   * Emitted when a response is received.
   */
  waitForEvent(event: 'response', optionsOrPredicate?: { predicate?: (response : Response) => boolean, timeout?: number }): Promise<Response>;

  /**
   * Emitted when a dedicated WebWorker is spawned by the page.
   */
  waitForEvent(event: 'worker', optionsOrPredicate?: { predicate?: (worker : Worker) => boolean, timeout?: number }): Promise<Worker>;
   ...
   */
  waitForRequest(urlOrPredicate: string|RegExp|Function, options?: PageWaitForRequestOptions): Promise<Request>;
   ...
   */
  waitForResponse(urlOrPredicate: string|RegExp|Function, options?: PageWaitForResponseOptions): Promise<Response>;
...
export interface Frame {
   ...
   * @param options 
   */
  dispatchEvent(selector: string, type: string, eventInit?: Object, options?: FrameDispatchEventOptions): Promise<void>;
   ...
   * @param options 
   */
  getAttribute(selector: string, name: string, options?: FrameGetAttributeOptions): Promise<null|string>;
   ...
   * @param options 
   */
  innerHTML(selector: string, options?: FrameInnerHTMLOptions): Promise<string>;
   ...
   * @param options 
   */
  innerText(selector: string, options?: FrameInnerTextOptions): Promise<string>;
   ...
   * @param options 
   */
  press(selector: string, key: string, options?: FramePressOptions): Promise<void>;
   ...
   * @returns An array of option values that have been successfully selected.
   */
  selectOption(selector: string, values: null|string|ElementHandle|Array<string>|FrameSelectOptionValues|Array<ElementHandle>|Array<Object>, options?: FrameSelectOptionOptions): Promise<Array<string>>;
   ...
   * @param options 
   */
  setInputFiles(selector: string, files: string|Array<string>|FrameSetInputFilesFiles|Array<Object>, options?: FrameSetInputFilesOptions): Promise<void>;
   ...
   * @param options 
   */
  textContent(selector: string, options?: FrameTextContentOptions): Promise<null|string>;
   ...
   * @returns Promise which resolves when the required load state has been reached.
   */
  waitForLoadState(state?: "load"|"domcontentloaded"|"networkidle", options?: FrameWaitForLoadStateOptions): Promise<void>;
...
export interface ElementHandle<T=Node> extends JSHandle<T> {
   ...
   * @returns An array of option values that have been successfully selected.
   */
  selectOption(values: null|string|ElementHandle|Array<string>|ElementHandleSelectOptionValues|Array<ElementHandle>|Array<Object>, options?: ElementHandleSelectOptionOptions): Promise<Array<string>>;

  /**
   * This method waits for actionability checks, then focuses the element and selects all its text content.
   * @param options 
   */
  selectText(options?: ElementHandleSelectTextOptions): Promise<void>;
   ...
   * @param options 
   */
  setInputFiles(files: string|Array<string>|ElementHandleSetInputFilesFiles|Array<Object>, options?: ElementHandleSetInputFilesOptions): Promise<void>;
...
export interface BrowserType<Browser> {
   ...
   */
  launchPersistentContext(userDataDir: string, options?: BrowserTypeLaunchPersistentContextOptions): Promise<BrowserContext>;
   ...
   */
  launchServer(options?: BrowserTypeLaunchServerOptions): Promise<BrowserServer>;
...
export interface ChromiumBrowser extends Browser {
   ...
   * @param options 
   */
  startTracing(page?: Page, options?: ChromiumBrowserStartTracingOptions): Promise<void>;
...
type DeviceDescriptor = {viewport: ViewportSize, userAgent: string};
...
export interface BrowserContext extends EventEmitter {
   ...
   * @param arg Optional argument to pass to `script` (only supported when passing a function).
   */
  addInitScript(script: Function|string|BrowserContextAddInitScriptScript, arg?: Serializable): Promise<void>;
   ...
   * @param options 
   */
  grantPermissions(permissions: Array<string>, options?: BrowserContextGrantPermissionsOptions): Promise<void>;
   ...
   * @param geolocation 
   */
  setGeolocation(geolocation: null|BrowserContextSetGeolocationGeolocation): Promise<void>;
   ...
   */
  setHTTPCredentials(httpCredentials: null|BrowserContextSetHTTPCredentialsHttpCredentials): Promise<void>;
   ...
   * **NOTE** Use `page.waitForLoadState([state[, options]])` to wait until the page gets to a particular state (you should not need it in most cases).
   */
  waitForEvent(event: 'page', optionsOrPredicate?: { predicate?: (page : Page) => boolean, timeout?: number }): Promise<Page>;
...
export interface FileChooser {
   ...
   * @param options 
   */
  setFiles(files: string|Array<string>|FileChooserSetFilesFiles|Array<Object>, options?: FileChooserSetFilesOptions): Promise<void>;
}
...
export interface Selectors {
   ...
   * @param options 
   */
  register(name: string, script: Function|string|SelectorsRegisterScript, options?: SelectorsRegisterOptions): Promise<void>;
}
...
export interface Accessibility {
   ...
   */
  snapshot(options?: AccessibilitySnapshotOptions): Promise<null|AccessibilitySnapshot>;
}
...
export interface Logger {
   ...
   */
  log(name: string, severity: "verbose"|"info"|"warning"|"error", message: string|Error, args: Array<Object>, hints: LoggerLogHints): void;
}
...
export interface ChromiumBrowserContext extends BrowserContext {
   ...
   * **NOTE** Only works with persistent context.
   */
  waitForEvent(event: 'backgroundpage', optionsOrPredicate?: { predicate?: (page : Page) => boolean, timeout?: number }): Promise<Page>;

  /**
   * Emitted when new service worker is created in the context.
   */
  waitForEvent(event: 'serviceworker', optionsOrPredicate?: { predicate?: (worker : Worker) => boolean, timeout?: number }): Promise<Worker>;
...
export interface ChromiumCoverage {
   ...
   */
  startCSSCoverage(options?: ChromiumCoverageStartCSSCoverageOptions): Promise<void>;
   ...
   * @returns Promise that resolves when coverage is started
   */
  startJSCoverage(options?: ChromiumCoverageStartJSCoverageOptions): Promise<void>;
...
interface FileChooserSetFilesFiles {
  /**
   * File name **required**
   */
  name: string;
...
interface ConsoleMessageLocation {
  /**
   * Optional URL of the resource if available.
   */
  url?: string;

  /**
   * Optional 0-based line number in the resource if available.
   */
  lineNumber?: number;

  /**
   * Optional 0-based column number in the resource if available.
   */
  columnNumber?: number;
}
...
interface BrowserTypeLaunchServerOptions {
   ...
   */
  proxy?: BrowserTypeLaunchServerOptionsProxy;
...
interface BrowserTypeLaunchServerOptionsProxy {
  /**
...
interface BrowserTypeLaunchPersistentContextOptions {
   ...
   * Network proxy settings.
   */
  proxy?: BrowserTypeLaunchPersistentContextOptionsProxy;
   ...
   * Sets a consistent viewport for each page. Defaults to an 1280x720 viewport. `null` disables the default viewport.
   */
  viewport?: null|BrowserTypeLaunchPersistentContextOptionsViewport;
  ...
  geolocation?: BrowserTypeLaunchPersistentContextOptionsGeolocation;
   ...
   * Credentials for HTTP authentication.
   */
  httpCredentials?: BrowserTypeLaunchPersistentContextOptionsHttpCredentials;
...
interface BrowserTypeLaunchPersistentContextOptionsHttpCredentials {
  username: string;

  password: string;
}

interface BrowserTypeLaunchPersistentContextOptionsGeolocation {
  /**
   * Latitude between -90 and 90.
   */
  latitude: number;
...
interface BrowserTypeLaunchPersistentContextOptionsViewport {
  /**
   * page width in pixels.
   */
  width: number;
...
interface BrowserTypeLaunchPersistentContextOptionsProxy {
  /**
   * Proxy to be used for all requests. HTTP and SOCKS proxies are supported, for example `http://myproxy.com:3128` or `socks5://myproxy.com:3128`. Short form `myproxy.com:3128` is considered an HTTP proxy.
   */
  server: string;
...
interface ElementHandleSelectTextOptions {
  /**
   * Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the browserContext.setDefaultTimeout(timeout) or page.setDefaultTimeout(timeout) methods.
   */
  timeout?: number;
...
interface ElementHandleScrollIntoViewIfNeededOptions {
  /**
   * Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the browserContext.setDefaultTimeout(timeout) or page.setDefaultTimeout(timeout) methods.
   */
  timeout?: number;
...
interface ElementHandleHoverOptions {
  /**
...
interface ElementHandleDblclickOptions {
  /**
   * Defaults to `left`.
   */
  button?: "left"|"right"|"middle";
...
interface FrameTextContentOptions {
  /**
   * Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the browserContext.setDefaultTimeout(timeout) or page.setDefaultTimeout(timeout) methods.
   */
  timeout?: number;
...
interface FrameSetInputFilesOptions {
  /**
   * Actions that initiate navigations are waiting for these navigations to happen and for pages to start loading. You can opt out of waiting via setting this flag. You would only need this option in the exceptional cases such as navigating to inaccessible pages. Defaults to `false`.
   */
  noWaitAfter?: boolean;
...
interface FrameSetInputFilesFiles {
  /**
   * File name **required**
   */
  name: string;
...
interface FrameInnerTextOptions {
  /**
   * Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the browserContext.setDefaultTimeout(timeout) or page.setDefaultTimeout(timeout) methods.
   */
  timeout?: number;
...
interface FrameInnerHTMLOptions {
  /**
   * Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the browserContext.setDefaultTimeout(timeout) or page.setDefaultTimeout(timeout) methods.
   */
  timeout?: number;
...
interface FrameGetAttributeOptions {
  /**
   * Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the browserContext.setDefaultTimeout(timeout) or page.setDefaultTimeout(timeout) methods.
   */
  timeout?: number;
...
interface FrameDispatchEventOptions {
  /**
   * Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the browserContext.setDefaultTimeout(timeout) or page.setDefaultTimeout(timeout) methods.
   */
  timeout?: number;
...
interface PageTextContentOptions {
  /**
   * Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the browserContext.setDefaultTimeout(timeout) or page.setDefaultTimeout(timeout) methods.
   */
  timeout?: number;
...
interface PageSetViewportSizeViewportSize {
  /**
...
interface PageSetInputFilesOptions {
  /**
   * Actions that initiate navigations are waiting for these navigations to happen and for pages to start loading. You can opt out of waiting via setting this flag. You would only need this option in the exceptional cases such as navigating to inaccessible pages. Defaults to `false`.
   */
  noWaitAfter?: boolean;
...
interface PageSetInputFilesFiles {
  /**
   * File name **required**
   */
  name: string;
...
interface PageInnerTextOptions {
  /**
   * Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the browserContext.setDefaultTimeout(timeout) or page.setDefaultTimeout(timeout) methods.
   */
  timeout?: number;
...
interface PageInnerHTMLOptions {
  /**
   * Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the browserContext.setDefaultTimeout(timeout) or page.setDefaultTimeout(timeout) methods.
   */
  timeout?: number;
...
interface PageGetAttributeOptions {
  /**
   * Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the browserContext.setDefaultTimeout(timeout) or page.setDefaultTimeout(timeout) methods.
   */
  timeout?: number;
...
interface PageDispatchEventOptions {
  /**
   * Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the browserContext.setDefaultTimeout(timeout) or page.setDefaultTimeout(timeout) methods.
   */
  timeout?: number;
